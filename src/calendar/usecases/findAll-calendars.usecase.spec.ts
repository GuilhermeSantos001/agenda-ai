...
import { FindAllCalendarsUseCase } from './findAll-calendars.usecase';
import { NewCalendarInput } from '../dto/new-calendar.input';

describe('FindAllCalendarsUseCase', () => {
  ...
  it('Should be find all calendars', async () => {
    await expect(
      FindAllCalendarsUseCase.execute(database),
